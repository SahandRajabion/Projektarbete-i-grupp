...
class LoginMessage {
    ...
    private $messages = array('Username is required', 'Password is required', "Username or password is incorrect",
                              ...
                              "Threads topic is too long", "Threads topic cannot be empty", "Thread has been created", "Password has invalid characters");    
    ...
    public function getMessage() {
        ...
        if($this->messageId < 9 || $this->messageId == 14 || $this->messageId == 15 || $this->messageId == 16 
          || $this->messageId == 18 || $this->messageId == 19 || $this->messageId == 20 || $this->messageId == 21 || $this->messageId == 23 || $this->messageId == 24 || $this->messageId == 25 || $this->messageId == 28 || $this->messageId == 29) {
