		...
		public function InboxHTML() {
			    ...
			    $open = $this->messagesRepository->getIfOpenOrNot($this->loginModel->getId());
		                  ...
		                  if ($open != null) {
		                       ...
		                       if ($open == 1) {
		                                              # code...
                         $html .= '<li class="active"><a name="Inbox" href="?' . $this->inboxLocation ."&".$this->id."=".$this->loginModel->getId().'">Inbox <span class="badge">1</span></a></li>';
                       }
                       else {
                           $html .= '<li class="active"><a name="Inbox" href="?' . $this->inboxLocation ."&".$this->id."=".$this->loginModel->getId().'">Inbox  <span class="badge">' . $open . '</span></a></li>';
                       }
		                  }
		                  else {
