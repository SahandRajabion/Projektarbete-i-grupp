	                    ...
	                    <form action='' class='form-horizontal' method=post enctype=multipart/form-data>
	                       <fieldset>
						     ...
						     <div class='form-group'>
						         ...
						         <div class='col-sm-10'>
						           <input class='form-control' name='$this->subjectLocation' type='text' maxlength='32'>
						         </div>
						      </div>
						      ...
						      <div class='form-group'>
						         ...
						         <div class='col-sm-10'>
						           <textarea rows='20' cols='50' class='form-control' name='$this->sendMessageLocation' type='text' maxlength='500'></textarea>
						         </div>
						      </div>
